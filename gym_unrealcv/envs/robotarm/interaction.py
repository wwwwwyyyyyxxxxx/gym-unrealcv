...
class Robotarm(UnrealCv):
    ...
    def define_observation(self, cam_id, observation_type, setting, mode='fast'):
        ...
        if observation_type == 'Color' or observation_type == 'CG':
            ...
            s_high = setting['pose_range']['high'] + setting['goal_range']['high'] + setting['continuous_actions']['high'] + setting['pose_xyz_range']['high'] # arm_pose, target_position, action
            s_low = setting['pose_range']['low'] + setting['goal_range']['low'] + setting['continuous_actions']['low'] + setting['pose_xyz_range']['low']
